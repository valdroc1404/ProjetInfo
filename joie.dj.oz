...
local
   ...
   Interlude = [a a b g nil etirer(facteur:0.5 [b c5])
                    b g a etirer(facteur:0.5 [b c5])
                b a g a etirer(facteur:2.0 d) ]

   % Ceci n'est pas une musique
   Partition = [duree( secondes:10.0 instrument(nom:voice [Tune End1 Tune End2 ])) duree( secondes:10.0 instrument(nom:syntklocka_stab [Interlude Tune End2 ]))]
in
